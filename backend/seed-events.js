...
async function seedEvents() {
  try {
    ...
    const events = [
      {
        ...
        detailedDescription: "Full-day event featuring keynote speeches from tech leaders, hands-on workshops, networking sessions, and career fair.",
    ...
    console.log(`✅ Added ${events.length} events successfully!`);
    
    await mongoose.disconnect();
    console.log('✅ Disconnected from MongoDB');
    console.log('\n🎉 Seeding completed! You can now visit http://localhost:8000');
